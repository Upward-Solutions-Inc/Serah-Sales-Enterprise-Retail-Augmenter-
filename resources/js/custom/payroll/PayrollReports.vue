            ...
            <div class="datatable">
                ...
                <div class="table-responsive custom-scrollbar table-view-responsive shadow pt-primary position-relative">
                    ...
                    >
                        ...
                        <div><strong>Allowance:</strong> {{ formatCurrency(report.allowance) }}</div>
                        ...
                        <button class="btn btn-sm btn-outline-primary" @click.prevent="showPayrollDetails(report)">View</button>
